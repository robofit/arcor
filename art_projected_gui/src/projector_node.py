...
def main(args):
    ...
    camera_depth_topic = rospy.get_param('~camera_depth_topic', '/kinect2/sd/image_depth_rect')
    ...
    proj = Projector(projector_id,  screen_number, camera_image_topic,  camera_depth_topic,  camera_info_topic,  calibration_matrix)
