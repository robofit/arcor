...
class ArtBasicControl:
    ...
    def __init__(self):
        ...
        self.left_interaction_off = rospy.Service("left_arm/interaction/get_ready", Empty,
                                                  self.left_interaction_get_ready_cb)
        self.left_interaction_off = rospy.Service("left_arm/interaction/move_to_user", Empty,
        ...
        self.right_interaction_off = rospy.Service("right_arm/interaction/get_ready", Empty,
                                                   self.right_interaction_get_ready_cb)
        self.right_interaction_off = rospy.Service("right_arm/interaction/move_to_user", Empty,
